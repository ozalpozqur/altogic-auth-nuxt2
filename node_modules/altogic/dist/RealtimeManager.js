...
var _RealtimeManager_instances, _RealtimeManager_socket, _RealtimeManager_autoJoinChannels, _RealtimeManager_echoMessages, _RealtimeManager_bufferMessages, _RealtimeManager_channels, _RealtimeManager_userData, _RealtimeManager_establishConnection, _RealtimeManager_joinChannels;
 ...
 */
class RealtimeManager extends APIBase_1.APIBase {
    /**
     ...
     */
    constructor(fetcher, { realtime }) {
        var _a, _b, _c;
        super(fetcher);
        _RealtimeManager_instances.add(this);
        /**
         ...
         * @type {object}
         */
        _RealtimeManager_socket.set(this, void 0);
        /**
         ...
         * @type {boolean}
         */
        _RealtimeManager_autoJoinChannels.set(this, void 0);
        /**
         ...
         * @type {object}
         */
        _RealtimeManager_echoMessages.set(this, void 0);
        /**
         ...
         * @type {number}
         */
        _RealtimeManager_bufferMessages.set(this, void 0);
        /**
         ...
         * @type {Map}
         */
        _RealtimeManager_channels.set(this, void 0);
        /**
         * Keeps a reference to the latest user data that is updated using the {@link update} method.
         * @type {number}
         */
        _RealtimeManager_userData.set(this, void 0);
        __classPrivateFieldSet(this, _RealtimeManager_autoJoinChannels, (_a = realtime === null || realtime === void 0 ? void 0 : realtime.autoJoinChannels) !== null && _a !== void 0 ? _a : true, "f");
        __classPrivateFieldSet(this, _RealtimeManager_echoMessages, (_b = realtime === null || realtime === void 0 ? void 0 : realtime.echoMessages) !== null && _b !== void 0 ? _b : true, "f");
        __classPrivateFieldSet(this, _RealtimeManager_bufferMessages, (_c = realtime === null || realtime === void 0 ? void 0 : realtime.bufferMessages) !== null && _c !== void 0 ? _c : true, "f");
        __classPrivateFieldSet(this, _RealtimeManager_channels, new Map(), "f");
        __classPrivateFieldSet(this, _RealtimeManager_userData, null, "f");
        __classPrivateFieldGet(this, _RealtimeManager_instances, "m", _RealtimeManager_establishConnection).call(this, realtime);
    }
    /**
    ...
    onConnect(listener) {
        ...
        if (listener)
            __classPrivateFieldGet(this, _RealtimeManager_socket, "f").on("connect", listener);
    }
    /**
    ...
    onReconnectAttempt(listener) {
        // Register the event listener
        if (listener)
            __classPrivateFieldGet(this, _RealtimeManager_socket, "f").io.on("reconnect_attempt", listener);
    }
    /**
    ...
    onDisconnect(listener) {
        // Register the event listener
        if (listener)
            __classPrivateFieldGet(this, _RealtimeManager_socket, "f").on("disconnect", listener);
    }
    /**
    ...
    onError(listener) {
        // Register the event listener
        if (listener)
            __classPrivateFieldGet(this, _RealtimeManager_socket, "f").on("connect_error", listener);
    }
    /**
     ...
     */
    open() {
        if (__classPrivateFieldGet(this, _RealtimeManager_socket, "f").disconnected)
            __classPrivateFieldGet(this, _RealtimeManager_socket, "f").open();
    }
    /**
     ...
     */
    close() {
        if (__classPrivateFieldGet(this, _RealtimeManager_socket, "f").connected)
            __classPrivateFieldGet(this, _RealtimeManager_socket, "f").close();
    }
    /**
     ...
     */
    getSocketId() {
        return __classPrivateFieldGet(this, _RealtimeManager_socket, "f").id;
    }
    /**
     ...
     */
    isConnected() {
        return __classPrivateFieldGet(this, _RealtimeManager_socket, "f").connected;
    }
    /**
    ...
    on(eventName, listener) {
        if (listener)
            __classPrivateFieldGet(this, _RealtimeManager_socket, "f").on(eventName, listener);
    }
    /**
    ...
    onAny(listener) {
        if (listener)
            __classPrivateFieldGet(this, _RealtimeManager_socket, "f").onAny(listener);
    }
    /**
    ...
    once(eventName, listener) {
        if (listener)
            __classPrivateFieldGet(this, _RealtimeManager_socket, "f").once(eventName, listener);
    }
    /**
    ...
    off(eventName, listener) {
        __classPrivateFieldGet(this, _RealtimeManager_socket, "f").off(eventName, listener);
    }
    /**
     ...
     */
    offAny(listener) {
        __classPrivateFieldGet(this, _RealtimeManager_socket, "f").off(listener);
    }
    /**
    ...
    getListeners(eventName) {
        return __classPrivateFieldGet(this, _RealtimeManager_socket, "f").listeners(eventName);
    }
    /**
     ...
     */
    broadcast(eventName, message, echo) {
        (0, helpers_1.checkRequired)("eventName", eventName, true);
        if (__classPrivateFieldGet(this, _RealtimeManager_bufferMessages, "f"))
            __classPrivateFieldGet(this, _RealtimeManager_socket, "f").emit("message", { eventName, message });
        else
            __classPrivateFieldGet(this, _RealtimeManager_socket, "f").volatile.emit("message", { eventName, message, echo });
    }
    /**
     ...
     */
    send(channel, eventName, message, echo) {
        (0, helpers_1.checkRequired)("channel", channel, true);
        (0, helpers_1.checkRequired)("eventName", eventName, true);
        if (__classPrivateFieldGet(this, _RealtimeManager_bufferMessages, "f"))
            __classPrivateFieldGet(this, _RealtimeManager_socket, "f").emit("message", { channel, eventName, message });
        else
            __classPrivateFieldGet(this, _RealtimeManager_socket, "f").volatile.emit("message", {
                channel,
                eventName,
                message,
                echo,
    ...
    join(channel, echo) {
        (0, helpers_1.checkRequired)("channel", channel, true);
        __classPrivateFieldGet(this, _RealtimeManager_socket, "f").emit("join", { channel, echo });
        // Add channel to joined channels list
        __classPrivateFieldGet(this, _RealtimeManager_channels, "f").set(channel, echo !== null && echo !== void 0 ? echo : __classPrivateFieldGet(this, _RealtimeManager_echoMessages, "f"));
    }
    /**
    ...
    leave(channel, echo) {
        (0, helpers_1.checkRequired)("channel", channel, true);
        __classPrivateFieldGet(this, _RealtimeManager_socket, "f").emit("leave", { channel, echo });
        // Remove channel from joined channels list
        __classPrivateFieldGet(this, _RealtimeManager_channels, "f").delete(channel);
    }
    /**
     ...
     * @returns {void}
     */
    updateProfile(data, echo) {
        __classPrivateFieldGet(this, _RealtimeManager_socket, "f").emit("update", { data, echo });
        // Keep reference to latest user data
        __classPrivateFieldSet(this, _RealtimeManager_userData, data, "f");
    }
    /**
    ...
    onJoin(listener) {
        if (listener)
            __classPrivateFieldGet(this, _RealtimeManager_socket, "f").on("channel:join", listener);
    }
    /**
    ...
    onLeave(listener) {
        if (listener)
            __classPrivateFieldGet(this, _RealtimeManager_socket, "f").on("channel:leave", listener);
    }
    /**
    ...
    onUpdate(listener) {
        if (listener)
            __classPrivateFieldGet(this, _RealtimeManager_socket, "f").on("channel:update", listener);
    }
    /**
    ...
    getMembers(channel) {
        ...
        return new Promise((resolve, reject) => {
            __classPrivateFieldGet(this, _RealtimeManager_socket, "f")
                .timeout(AWAIT_TIMEOUT)
                .emit("members", { channel }, (err, response) => {
                if (err)
                    reject(err);
                else
                    resolve(response);
    ...
    onUserEvent(listener) {
        if (listener) {
            __classPrivateFieldGet(this, _RealtimeManager_socket, "f").on("user:signin", listener);
            __classPrivateFieldGet(this, _RealtimeManager_socket, "f").on("user:signout", listener);
            __classPrivateFieldGet(this, _RealtimeManager_socket, "f").on("user:update", listener);
            __classPrivateFieldGet(this, _RealtimeManager_socket, "f").on("user:delete", listener);
            __classPrivateFieldGet(this, _RealtimeManager_socket, "f").on("user:pwdchange", listener);
            __classPrivateFieldGet(this, _RealtimeManager_socket, "f").on("user:emailchange", listener);
            __classPrivateFieldGet(this, _RealtimeManager_socket, "f").on("user:phonechange", listener);
        }
    }
}
exports.RealtimeManager = RealtimeManager;
_RealtimeManager_socket = new WeakMap(), _RealtimeManager_autoJoinChannels = new WeakMap(), _RealtimeManager_echoMessages = new WeakMap(), _RealtimeManager_bufferMessages = new WeakMap(), _RealtimeManager_channels = new WeakMap(), _RealtimeManager_userData = new WeakMap(), _RealtimeManager_instances = new WeakSet(), _RealtimeManager_establishConnection = function _RealtimeManager_establishConnection(realtime) {
    var _a, _b;
    const urlInfo = (0, helpers_1.parseRealtimeEnvUrl)(this.fetcher.getBaseUrl());
    __classPrivateFieldSet(this, _RealtimeManager_socket, (0, socket_io_client_1.default)(urlInfo.realtimeUrl, {
        reconnection: true,
        reconnectionDelay: (_a = realtime === null || realtime === void 0 ? void 0 : realtime.reconnectionDelay) !== null && _a !== void 0 ? _a : RECONNECTION_DELAY,
        timeout: (_b = realtime === null || realtime === void 0 ? void 0 : realtime.timeout) !== null && _b !== void 0 ? _b : TIMEOUT,
        transports: ["websocket", "polling"],
        auth: {
            echoMessages: __classPrivateFieldGet(this, _RealtimeManager_echoMessages, "f"),
    ...
    __classPrivateFieldGet(this, _RealtimeManager_socket, "f").io.on("reconnect", () => {
        // If autojoin channels enabled then join already subscribed channels
        if (__classPrivateFieldGet(this, _RealtimeManager_autoJoinChannels, "f"))
            __classPrivateFieldGet(this, _RealtimeManager_instances, "m", _RealtimeManager_joinChannels).call(this);
    });
}, _RealtimeManager_joinChannels = function _RealtimeManager_joinChannels() {
    // In case of reconnection we should also update the user data to its latest value
    if (__classPrivateFieldGet(this, _RealtimeManager_userData, "f"))
        this.updateProfile(__classPrivateFieldGet(this, _RealtimeManager_userData, "f"), __classPrivateFieldGet(this, _RealtimeManager_echoMessages, "f"));
    __classPrivateFieldGet(this, _RealtimeManager_channels, "f").forEach((echo, channel) => {
